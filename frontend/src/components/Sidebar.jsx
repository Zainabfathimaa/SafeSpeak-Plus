...
import { LayoutDashboard, FileText, MessageSquare, BookOpen, Settings } from 'lucide-react';
...
export function Sidebar() {
    ...
    return (
        <aside className="hidden md:block w-64 glass-panel border-r border-white/40 h-screen sticky top-0 flex flex-col justify-between shadow-[4px_0_24px_rgba(0,0,0,0.02)] z-40">
            ...
            <div className="p-5 border-t border-white/50 bg-gradient-to-t from-white/40 to-transparent">
                <Link
                    to="/settings"
